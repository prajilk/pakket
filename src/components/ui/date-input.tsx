...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
    ...
    return (
        <div className="flex items-center px-1 text-sm border rounded-lg">
            <input
                type="text"
                ref={monthRef}
                max={12}
            ...
            <input
                ...
                className="p-0 text-center border-none outline-none w-7"
                placeholder="D"
            />
            <span className="-mx-px opacity-20">/</span>
            <input
                ...
                className="w-12 p-0 text-center border-none outline-none"
                placeholder="YYYY"
            />
        </div>
    );
